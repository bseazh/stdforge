...
<p align="center">
  <img src="assets/generated/1786762413865-f156d0dd0512b1e5.png" alt="规矩：标准采集、结构化、审核、协同与发布流程" width="100%" />
</p>

规矩（RuleCraft）是一个面向标准化工程师与政策研究人员的 AI 标准全生命周期协同平台演示。它把“标准公告采集、文件解析、条款级审核与协同修订、政策解读”放在同一条可追溯流程中。
